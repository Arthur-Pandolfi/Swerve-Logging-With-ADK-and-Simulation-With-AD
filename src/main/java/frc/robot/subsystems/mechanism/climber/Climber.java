...
import frc.frc_java9485.constants.ClimberConsts;
...
public class Climber extends SubsystemBase implements ClimberIO {
    ...
    private Climber() {
        ...
        left = new SparkMaxMotor(ClimberConsts.LEFT_ID, "climber esquerda");
        right = new SparkMaxMotor(ClimberConsts.RIGHT_ID, "climber direita");
